...
public class CloudFirebase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMail=getIntent().getStringExtra("mail");
    ...
    private void uploadFile(Uri uri) {
        ...
        StorageReference uploadStorageReference = mStorageReferenceImages.child(mMail).child(uri.getAuthority());
        ...
        uploadTask
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        showAlertDialog(CloudFirebase.this, "Upload Complete", downloadUrl.toString(), new DialogInterface.OnClickListener() {
                            @Override
                ...
                .addOnProgressListener(CloudFirebase.this, new OnProgressListener<UploadTask.TaskSnapshot>() {
                    @Override
    ...
    private void downloadFile(Uri uri) {
        ...
        storageReferenceImage.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
            ...
            public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                hideProgressDialog();
                showAlertDialog(CloudFirebase.this, "Download Complete", localFile.getAbsolutePath(), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
    ...
    private void deleteFile(Uri uri) {
        ...
        storageReferenceImage.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                hideProgressDialog();
                showAlertDialog(CloudFirebase.this, "Success", "File deleted successfully.", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        //mImageView.setImageResource(R.drawable.placeholder_image);
                        //findViewById(R.id.button_step_3).setEnabled(true);
